    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
            ...
            .authorizeHttpRequests(authorize -> authorize
            		...
            		.requestMatchers(HttpMethod.GET, "/areas-corpo/listar", "/procedimentos/listar").permitAll()
            		.requestMatchers(HttpMethod.GET, "/areas-corpo/listar/{id}", "/procedimentos/listar/{id}").permitAll()
                    ...
                    .requestMatchers(HttpMethod.POST, "/disponibilidade/criar-disponibilidade").hasRole("USUARIO_FUN")
